                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content ventanaeliminar">
                            ...
                            <div class="modal-footer">
                                <a class="btn btn-warning" href="EliminarInventario?Id=<%= I.getId()%>" >Aceptar</a>
            ...
            <div class="modal fade" id="myModal" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="RegistroInventario" method="POST"class="form-horizontal validaciones" id="">
                                <fieldset>
                                    <!-- Text input-->
                ...
                <div class="modal fade" id="myModaleditar" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="EditarInventario" method="POST" class="form-horizontal validaciones" id="">
                                    <fieldset>
                                        <!-- Text input-->
                                        <div class="form-group">
                                            <div class="col-md-5">
