                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content ventanaeliminar">
                            ...
                            <div class="modal-footer">
                                ...
                                <a class="btn btn-warning" href="EliminarCliente?cedula=<%=P.getCedula()%>&Tarea=Habilitar" >Aceptar</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade" id="myModaleliminar<%=P.getCedula()%>" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content ventanaeliminar">
                            ...
                            <div class="modal-footer">
                                <a class="btn btn-warning" href="EliminarCliente?cedula=<%= P.getCedula()%>&Eliminar=deshabilitar" >Aceptar</a>
                                <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal fade" id="myModaleditar" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form  action="EditarCliente " method="GET" class="form-horizontal validaciones">
                                <fieldset>
                                    <!-- Text input1-->
