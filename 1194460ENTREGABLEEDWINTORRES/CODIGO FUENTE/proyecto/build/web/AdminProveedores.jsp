                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-warning" data-toggle="modal" data-target="#myModalHabilitar<%=p.getNit()%> "><span class="glyphicon glyphicon-ok"></span></a>
                        </td>         
                    </tr> 
                    <!--MODAL PARA HABILITAR proveedor-->
                <div class="modal fade" id="myModalHabilitar<%=p.getNit()%>" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content ventanaeliminar">
                            <div class="modal-header">
                                ...
                                <h4>¿Habilitar Producto?</h4>
                            </div>
                            <div class="modal-body">
                                <p>¿Seguro que quieres Habilitar este Producto?</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                                <a class="btn btn-warning" href="EliminarProveedor?Nit=<%= p.getNit()%>&Tarea=Habilitar" >Aceptar</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade" id="myModaleliminar<%=p.getNit()%>" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content ventanaeliminar">
                            ...
                            <div class="modal-footer">
                                <a class="btn btn-warning" href="EliminarProveedor?Nit=<%=p.getNit()%>&Eliminar=deshabilitar">Guardar</a>
                                <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal fade" id="myModal" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="RegistroProveedor" method="GET" class="form-horizontal validaciones">
                                <fieldset>
                                    <!-- Text input-->
            ...
            <div class="modal fade" id="myModaleditar" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="EditarProveedor" method="GET" class="form-horizontal validaciones" >
                                <fieldset>
