            ...
            <table id="myTable" class="table table-striped table-bordered dt-responsive nowrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-warning" onclick="modal2('<%=p.getNombre()%>', '<%=p.getValor()%>', '<%=p.getTipoId()%>')" data-toggle="modal" data-target="#myModallist"><span class="glyphicon glyphicon-eye-open"></span></a>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content ventanaeliminar">
                            ...
                            <div class="modal-footer">
                                ...
                                <a class="btn btn-warning" href="EliminarProducto?Id=<%= p.getId()%>&Eliminar=deshabilitar" >Aceptar</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade" id="myModalHabilitar<%=p.getId()%>" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content ventanaeliminar">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                                <a class="btn btn-warning" href="EliminarProducto?Id=<%= p.getId()%>&Tarea=Habilitar" >Aceptar</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal fade" id="myModaleditar" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="EditarProducto" method="GET"  class="form-horizontal validaciones" > 
                            <fieldset>
                                <!-- Text input-->
            ...
            <div class="modal fade" id="myModal" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="RegistroProducto" method="GET" class="form-horizontal validaciones">
                                <fieldset>
                                    <!-- Text input-->
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Nombre Producto</label>  
