        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if ((ses.getAttribute("rol")) == null) {
                ...
                try {
                    ...
                    if (Tarea == null) {
                        String query = "UPDATE INVENTARIOS SET HABILITADO=0 WHERE ID=" + id + ";";
                        ...
                        if (Eliminar == null) {
                            ...
                            response.sendRedirect("ListarInventario?Tarea=ListarInventario");
                        }

                    } else {
                        String query = "UPDATE INVENTARIOS SET HABILITADO=1 WHERE ID=" + id + ";";
                        stm.executeUpdate(query);
                        con.cierraConexion();
                        c.close();
                        stm.close();
