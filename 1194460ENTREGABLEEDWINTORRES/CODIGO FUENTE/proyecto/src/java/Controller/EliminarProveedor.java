    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if ((ses.getAttribute("rol")) == null) {
                ...
                String query = "";
                if (Tarea == null) {
                    query = "UPDATE PROVEEDORES SET HABILITADO=0 WHERE NIT=" + Nit + ";";
                    ...
                    if (Eliminar == null) {
                        ...
                        response.sendRedirect("ListarProveedor?Tarea=ListarAdmin");
                    }
                } else {
                    query = "UPDATE PROVEEDORES SET HABILITADO=1 WHERE NIT=" + Nit + ";";
                    stm.executeUpdate(query);
                    con.cierraConexion();
                    c.close();
                    stm.close();
