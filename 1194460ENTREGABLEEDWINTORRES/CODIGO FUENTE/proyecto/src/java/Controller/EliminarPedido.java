        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if ((ses.getAttribute("rol")) == null) {
                ...
                try {
                    ...
                    String query = "";
                    if (Tarea == null) {
                        query = "UPDATE PEDIDOS SET HABILITADO=0,ESTADO=1 WHERE id=" + id + ";";
                        ...
                        if (Eliminar == null) {
                            ...
                            response.sendRedirect("ListarPedido?Tarea=ListarAdmin");
                        }
                    } else {
                        query = "UPDATE PEDIDOS SET HABILITADO=1 WHERE id=" + id + ";";
                        stm.executeUpdate(query);
                        con.cierraConexion();
                        c.close();
                        stm.close();
