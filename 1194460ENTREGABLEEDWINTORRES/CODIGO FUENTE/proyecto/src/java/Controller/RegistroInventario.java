 ...
 * @author ficha1194460
 */
@WebServlet(urlPatterns = {"/RegistroInventario"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if ((ses.getAttribute("rol")) == null) {
                ...
                String valunit = request.getParameter("valorunitario");
                int valorunitario = Integer.parseInt(valunit);
                //recupero datos de la session
                String rol = (String) ses.getAttribute("rol");
                String usuario = (String) ses.getAttribute("nombre");
                try {
                    String query = "INSERT INTO INVENTARIOS(FECHA,PRODUCTO,CANTIDAD,VALOR_UNITARIO,VALOR_TOTAL,HABILITADO)"
                            + "VALUES( NOW(),'" + producto + "'," + cantidad + "," + valorunitario + "," + cantidad * valorunitario + "," + 1 + ");";
