<%-- 
    ...
    Created on : 21/11/2017, 08:35:00 PM
    Author     : Arley
--%>
...
conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/PANADERIA","root","adsi");
/*Establecemos la ruta del reporte*/ 
File reportFile = new File(application.getRealPath("/Reportes/ReporteProductos.jasper")); 
