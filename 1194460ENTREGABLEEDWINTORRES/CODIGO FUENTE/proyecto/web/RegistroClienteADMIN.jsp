            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="well well-sm">
                        <form id="" class="form-horizontal validaciones"  method="POST" action="RegistroClientesADMIN">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 text-center">
                                        <a type="button" href="ListarCliente"  class="btn btn-default btn-lg">Cancelar</a>
