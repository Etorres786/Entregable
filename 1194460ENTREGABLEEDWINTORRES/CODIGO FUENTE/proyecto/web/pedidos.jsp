                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-warning" data-toggle="modal" data-target="#myModaleliminar<%=P.getId()%> "><span class="glyphicon glyphicon-check "></span></a>
            ...
            <div class="modal fade" id="myModal" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="RegistroPedido" method="POST" class="form-horizontal">
                                <fieldset>
                                    <!-- Text input-->
            ...
            <div class="modal fade" id="myModaleditar" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="EditarPedido" method="POST" class="form-horizontal">
                                <fieldset>
                                    <!-- Text input-->
                                    <div class="form-group">
                                        <div class="col-md-4">
